...
function TriangleClickable:isHovering()
    ...
    area2 = math.abs((self.verticies[2][1] - x)*(self.verticies[3][3] - y) - (self.verticies[3][1] - x)*(self.verticies[2][2] - y))
    area2 = math.abs((self.verticies[3][1] - x)*(self.verticies[1][2] - y) - (self.verticies[1][1] - x)*(self.verticies[3][2] - y))
